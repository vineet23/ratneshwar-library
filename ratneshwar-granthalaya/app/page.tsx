  ...
  useEffect(() => {
    const translations = {
      en: {
        ...
        addressLine:
          "Kasba Dhamanse, Tal. Rajapur, Dist. Ratnagiri, Maharashtra",
      ...
      mr: {
        ...
        navAboutMobile: "आमच्याबद्दल",
        navGalleryMobile: "गॅलरी",
        navVisitMobile: "भेट द्या",
        navAppealMobile: "सहकार्य करा",
        heroTitle: "एक नवीन अध्याय.",
        heroSubtitle: "'इथे पक्ष उपपक्ष भाषा नсаवी! जनासाठी ग्रंथालये चालवावी!'",
        ...
        visitAddress: "पत्ता",
        addressLine:
          "कसबा धामणसे, ता. राजापूर, जि. रत्नागिरी, महाराष्ट्र",
    ...
    const langButtons = [
      ...
      document.getElementById("lang-mr"),
      document.getElementById("lang-en-mobile"),
      document.getElementById("lang-mr-mobile"),
    ];
    ...
    langButtons.forEach((button) => {
      if (button) {
        button.addEventListener("click", (e) => {
          const lang = (e.target as HTMLElement).id.includes("en")
            ? "en"
            : "mr";
          updateLanguage(lang);
        });
      ...
      <header className="sticky top-0 z-50 border-b border-gray-200/60">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          <a
            ...
            data-lang="libraryName"
          >
            श्री रत्नेश्वर ग्रंथालय
          </a>
      ...
      <main>
        ...
        <section className="min-h-screen bg-black flex flex-col justify-center items-center text-center text-white p-6 relative overflow-hidden">
          ...
          <div className="z-10 reveal">
            <h1
              className="text-5xl md:text-8xl font-black tracking-tighter hero-text-glow"
              data-lang="heroTitle"
            >
              एक नवीन अध्याय.
            </h1>
            <p
              ...
              data-lang="heroSubtitle"
            >
              'इथे पक्ष उपपक्ष भाषा नसावी! जनासाठी ग्रंथालये चालवावी!'
            </p>
            <div className="mt-8 flex justify-center gap-4">
              <a
                ...
                data-lang="heroExplore"
              >
                आमचा प्रवास जाणून घ्या
              </a>
            </div>
          </div>
        </section>
        ...
        <section id="about" className="pt-24 pb-16 scroll-mt-20">
          <div className="container mx-auto px-6">
            <div className="reveal text-center">
              <h2
                className="section-headline text-gray-900"
            ...
            <div className="max-w-4xl mx-auto mt-12 content-prose">
              <div className="reveal">
                <p data-lang="aboutIntro">
                  सप्रेम नमस्कार ! 'इथे पक्ष उपपक्ष भाषा नसावी! जनासाठी ग्रंथालये
                  चालवावी!' हे ब्रीदवाक्य घेऊन आम्ही सन १९७६ पासून 'श्री रत्नेश्वर
                  ग्रंथालयाची' उत्तरोत्तर प्रगती करत आज स्वमालकीच्या दिमाखदार
                  वास्तूत आणून उत्तम ग्रंथसंपदा लोकांपर्यंत पोचवली आहे. ही
                  स्वःस्तुती नसून ती शासकीयस्तरावर आणि वाचकांच्या प्रतिसादाची
                  उत्तम पोचपावती आहे.
                </p>
                <p data-lang="aboutKulkarni">
                  कै. किशोर शंकर कुळकर्णी हे तत्कालीन अध्यक्ष होत. त्यांनी आपला
                  किराणा व्यवसाय चालवत अतिशय प्रामाणिकपणे ग्रंथालय कसोशीने
                  चालवले. आज त्यांचे सुपुत्र श्री. उमेश किशोर कुळकर्णी हे अतिशय
                  वेगवान पद्धतीने श्री रत्नेश्वर ग्रंथालयाचा उत्कर्ष करीत आहेत.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto my-16 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center">
              ...
              <div className="reveal bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                ...
                <p className="text-sm text-gray-500 mt-1" data-lang="statYear">
                  स्थापना वर्ष
                </p>
              </div>
              {/* Card 2: Books */}
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-1" data-lang="statBooks">
                  ग्रंथ संपदा
                </p>
              </div>
              {/* Card 3: Area */}
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-1" data-lang="statArea">
                  चौ. फूट जागा
                </p>
              </div>
              {/* Card 4: Ambulance */}
              ...
              >
                ...
                <h3
                  ...
                  data-lang="statAmbulanceTitle"
                >
                  रुग्णवाहिका
                </h3>
                <p
                  className="text-sm text-gray-500 mt-1"
                  data-lang="statAmbulanceDesc"
                >
                  सेवा देणारे पहिले ग्रंथालय
                </p>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto content-prose">
              <div className="reveal">
                <blockquote data-lang="aboutQuote1">
                  'इवलेसे रोप लावियले दारी। त्याचा वेलू गेला गगनावरी ।।'
                </blockquote>
                <p data-lang="aboutBuilding">
                  या उक्तीचा प्रत्यय आणीत आज स्वमालकीची वास्तू निर्माण करण्यात यश
                  आले आहे. १२०० वर्ग आकाराचे ग्रंथालय आणि वल १२०० वर्ग आकाराचे
                  सभागृह कै. डी. एम. जोशी नावाने लोकांसाठी उपलब्ध आहे. इथे सर्व
                  प्रकारच्या सभा, कार्यक्रम होत असतात. याची बैठक व्यवस्था २००
                  जणांसाठी आहे. कार्यतत्पर संचालक आणि कर्तव्यदक्ष कर्मचारी
                  आमच्या ग्रंथालयास लाभले आहेत.
                </p>
              </div>

              {/* Journey Timeline Section */}
              <div className="reveal mt-16">
                <h3 data-lang="journeyTitle" className="text-center">
                  ग्रंथालयाची घौडदौड...
                </h3>
                        ...
                        <div className="pl-16 md:pl-0 md:w-1/2 md:pr-8">
                          <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm md:text-right">
                            <h4
                              ...
                              data-lang="timeline1976Title"
                            >
                              स्थापना
                            </h4>
                            <p
                              className="text-gray-600 mt-1"
                              data-lang="timeline1976Desc"
                            >
                              २६ जानेवारी १९७६ रोजी ग्रामीण 'ड' वर्गात
                              ग्रंथालयाची सुरुवात झाली.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="md:flex items-start">
                        ...
                        <div className="pl-16 md:pl-0 md:w-1/2 md:ml-auto md:pl-8">
                          <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
                            <h4
                              className="font-bold text-lg text-gray-900"
                              data-lang="timeline1986Title"
                            >
                              प्रगतीचा टप्पा
                            </h4>
                            <p
                              className="text-gray-600 mt-1"
                              data-lang="timeline1986Desc"
                            >
                              स्थानिक आणि मुंबईकर ग्रामस्थांच्या सहकार्याने
                              ग्रंथालय 'क' वर्गात रूपांतरित झाले.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="md:flex items-start">
                        ...
                        <div className="pl-16 md:pl-0 md:w-1/2 md:pr-8">
                          <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm md:text-right">
                            <h4
                              className="font-bold text-lg text-gray-900"
                              data-lang="timeline1997Title"
                            >
                              नवीन उपक्रम
                            </h4>
                            <p
                              className="text-gray-600 mt-1"
                              data-lang="timeline1997Desc"
                            >
                              'ब' वर्गात दर्जावाढ झाली आणि वाचकांसाठी अनेक नवीन
                              उपक्रम सुरू झाले.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="md:flex items-start">
                        ...
                        <div className="pl-16 md:pl-0 md:w-1/2 md:ml-auto md:pl-8">
                          <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
                            <h4
                              className="font-bold text-lg text-gray-900"
                              data-lang="timeline2013Title"
                            >
                              स्वप्नपूर्ती: नवीन वास्तू
                            </h4>
                            <p
                              className="text-gray-600 mt-1"
                              data-lang="timeline2013Desc"
                            >
                              दानशूर व्यक्तींच्या मदतीने, सुमारे ४३ लाख रुपये
                              खर्चून सुसज्ज इमारतीचे बांधकाम सुरू झाले.
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="reveal mt-16">
                <h3 data-lang="philosophyTitle">ग्रंथालये काळाची गरज</h3>
                <blockquote data-lang="philosophyQuote1">
                  न चोरहायें न राजहायें। न भातृ‌भाज्यं न च भारकारी। व्ययकृते
                  वर्धत एव नित्यं । विद्याधनं सर्वधनप्रधानं ।।
                </blockquote>
                <p data-lang="philosophyP1">
                  या प्रसिद्ध संस्कृत वचनानुसार विद्यारुपी धन प्राप्त करण्याचे
                  एकमेव साधन म्हणून मंथाचे अलौकिक महत्व दिसून येते. शिक्षण
                  प्रक्रियेचा विचार करता ती आजन्म अखंड अशी चालणारी प्रक्रिया आहे.
                  या प्रक्रियेत योग्यायोग्यतेची निवड करण्यासाठी अनेक वेळा
                  मार्गदर्शनाची गरज असते. नेमक्या अशा प्रसंगी 'पुस्तके काहीतरी
                  सांगू इच्छितात' या उक्तीनुसार मार्गदर्शनाची भूमिका ग्रंथ
                  पुर्णत्वास नेतात.
                </p>
                <p data-lang="philosophyP2">
                  माणसाला अन्नाच्या भूकेप्रमाणे मानसिक भूकही असते. अशी वाचनरुपी,
                  ज्ञानरुपी भूक भागविण्याचा प्रयत्न ग्रंथालयामार्फत केला जातो.
                  मानवाचा अज्ञानरुपी अंध:कार नाहिसा करून मानवी जीवनाचा मार्ग सुकर
                  करतो. ग्रंथांच्या सानिध्यात मानवाच्या शब्दसंपत्तीत भर पडते.
                  आकलन शक्तीचा विकास होतो व चौकस विचारांची शक्ती प्राप्त होते.
                </p>
                <blockquote data-lang="philosophyQuote2">
                  पुस्तकेषु च या विद्या परहस्तेषु यद्धनम् । उत्पन्नेषु च कार्येषु
                  न सा विद्या न तद्धनम् ॥
                </blockquote>
                <p data-lang="philosophyP3">
                  या संस्कृत वचनाचा विचार करून पुस्तकातील आत्मसात न केलेली
                  विद्या आपणास उपयोगी पडत नाही यासाठी आपल्याला प्राप्त झालेल्या
                  ग्रंथालयाच्या जास्तीत जास्त उपयोग करून त्याची वृद्धी करण्यात व
                  सुसज्ज बनविण्याच्या कामी मी सदैव प्रयत्न करीन असा मनाचा ठाम
                  निश्चय केला पाहिजे.
                </p>
              </div>

              <div className="reveal mt-10 bg-red-100 p-8 rounded-lg border border-red-300">
                <h3 className="mt-0" data-lang="appealTitle">
                  सहकार्याचे आवाहन
                </h3>
                <p data-lang="appealP1">
                  काळ बदलत चालला आहे. आताचा तरुणवर्ग वाचनासाठी मोबाईल, लॅपटॉप,
                  कॉम्प्युटर्सचा वापर फार मोठ्या प्रमाणावर करताना दिसतो. अशा
                  परिस्थितीत ग्रंथालयसुद्धा अपडेट असणे गरजेचे आहे म्हणून
                  आम्ही आपल्यासमोर आर्थिक सहकार्याची अपेक्षा करीत आहोत. कृपया
                  सहकार्य करावे.
                </p>
                <p data-lang="appealP2">
                  विकासात्मक प्रक्रियेसाठी लागणाऱ्या मान्यता जसे - नोंदणी
                  प्रमाणपत्र, पॅन, 12A, 80G certificate, CSR अशी प्रमाणपत्रे आज
                  आमच्याकडे उपलब्ध आहेतच.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="gallery" className="py-20 bg-white scroll-mt-20">
          <div className="container mx-auto px-6 text-center">
            <div className="reveal">
              <h2
                className="section-headline text-gray-900"
                data-lang="galleryTitle"
              >
                आमचे काही क्षण
              </h2>
              <p
                className="section-subheadline mt-6 max-w-3xl mx-auto"
                data-lang="galleryDesc"
              >
                प्रत्येक कोपरा उत्सुकता निर्माण करण्यासाठी आणि आमच्या समुदायाचे
                स्वागत करण्यासाठी तयार केला आहे.
              </p>
            </div>
        ...
        <section id="visit" className="py-24 scroll-mt-20">
          <div className="container mx-auto px-6 text-center">
            <div className="reveal">
              <h2
                className="section-headline text-gray-900"
                data-lang="visitTitle"
              >
                तुमच्या भेटीसाठी सज्ज.
              </h2>
              <div className="mt-10 grid md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
                <div className="bg-white p-8 rounded-lg border border-gray-200">
                  <h3
                    className="text-xl font-bold text-gray-900"
                    data-lang="visitHours"
                  >
                    उघडण्याची वेळ
                  </h3>
                  <div className="mt-4 space-y-2 text-gray-600">
                    <p className="flex justify-between">
                      <span data-lang="visitMonFri">सोम - शुक्र</span>{" "}
                      <strong>9:00 AM - 8:00 PM</strong>
                    </p>
                    <p className="flex justify-between">
                      <span data-lang="visitSatSun">शनि - रवि</span>{" "}
                ...
                <div className="bg-white p-8 rounded-lg border border-gray-200">
                  <h3
                    className="text-xl font-bold text-gray-900"
                    data-lang="visitAddress"
                  >
                    पत्ता
                  </h3>
                  <p className="mt-4 text-gray-600" data-lang="addressLine">
                    कसबा धामणसे, ता. राजापूर, जि. रत्नागिरी, महाराष्ट्र
                  </p>
                </div>
              </div>
      ...
      <footer id="contact" className="bg-gray-900 text-white">
        <div className="container mx-auto px-6 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold" data-lang="footerLibraryName">
                श्री रत्नेश्वर ग्रंथालय
              </h3>
              <p className="mt-2 text-gray-400" data-lang="footerSubtitle">
                ज्ञानाचा वारसा, पिढ्यानपिढ्या.
              </p>
            </div>
            <div>
              <h4 className="font-semibold" data-lang="footerQuickLinks">
                द्रुत दुवे
              </h4>
            ...
            <div>
              <h4 className="font-semibold" data-lang="footerFollow">
                आम्हाला फॉलो करा
              </h4>
          ...
          <div className="mt-12 border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
            <p data-lang="footerRights">
              &copy; 2025 श्री रत्नेश्वर ग्रंथालय. सर्व हक्क राखीव.
            </p>
          </div>
        </div>
      </footer>
